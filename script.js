...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=216").then(checkStatus).then(json).then(function (response) {
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "/mark_" + newState + "?api_key=216", {
        method: "PUT",
        mode: "cors"
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "?api_key=216", {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this6.fetchTasks(); // fetch tasks after delete
      }).catch(function (error) {
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=216", {
        method: "POST",
        mode: "cors",
          ...
          React.createElement(
            ...
            tasks.length > 0 ? tasks.filter(function (task) {
              ...
              return React.createElement(Task, {
                key: task.id,
                task: task,
                onDelete: _this8.deleteTask,
                onComplete: _this8.toggleComplete });
            }) : React.createElement(
              "p",
              null,
              "no tasks here"
